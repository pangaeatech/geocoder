...
lookup. The United States list carries its inhabited territories alongside the
states, since they hold United States addresses and are written with the same
two-letter codes. Mexican states are absent by design: they are abbreviated by
prefix ("Jal." for Jalisco, "Q.R." for Quintana Roo), which needs no table.
...
COUNTRY_BOUNDS: Dict[str, List[Tuple[float, float, float, float]]] = {
    "US": [
        ...
        (17.6, -67.3, 18.6, -64.5),
        (13.2, 144.6, 20.6, 146.1),
        (-14.6, -171.2, -14.1, -169.3),
    ],
